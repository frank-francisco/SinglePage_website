(function ($) {
	...
	/*----------------------------
		START - Scroll to Top pricing join click
		------------------------------ */

		$('#joining').click(function (e) {
			var $target = $('html, body');
			$target.animate({scrollTop : $('#downloader').offset().top},2000);
			return false;
		});


		$('#terming').click(function (e) {
			var $target = $('html, body');
			$target.animate({scrollTop : $('#terming-services').offset().top},2000);
			return false;
		});

		$('#privacing').click(function (e) {
			var $target = $('html, body');
			$target.animate({scrollTop : $('#privacing-policy').offset().top},2000);
			return false;
		});
        ...
        $('#meeting').click(function (e) {
			var $target = $('html, body');
			$target.animate({scrollTop : $('#team').offset().top},2000);
			return false;
		});
    
       $('#learning').click(function (e) {
			var $target = $('html, body');
			$target.animate({scrollTop : $('#pricing').offset().top},2000);
			return false;
		});
